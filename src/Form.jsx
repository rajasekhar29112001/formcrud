...
const Form = ({ obj, setObj, arr, setArr, filArr, setFilArr, search, setSearch }) => {
    ...
    function filterData(data) {
        ...
        // let filData = [];
        //     if (filData?.length) {
        //         filData = filData.filter((obj) => obj[key].includes(value));
        //     }
        //     else {
        //         filData = arr.filter((obj) => obj[key].includes(value));
        //     }

        // console.log("filData =", filData);
        // console.log("filData.length =", filData.length);

        setFilArr(filteredData);
    }
